...
\end{frame}}                                   %|
%-----------------------------------------------
% Affiche automatiquement le plan au début de chaque sous-section
\AtBeginSubsection[]
{
  \begin{frame}<beamer>
    \tableofcontents[
...
\newcommand{\class}[1]{
    \texttt{\textcolor{monCyan}{\textbf{#1}}}
}
\usetikzlibrary{shapes.geometric, arrows.meta, positioning}

\tikzstyle{event} = [rectangle, draw=black, rounded corners, text width=4.5cm, minimum height=1cm, text centered, font=\tiny]
